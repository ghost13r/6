...
client.user.setGame(`.help|Ghost`,"http://twitch.tv/Ghost")
...
client.on("message", async message => {
    if(message.content.startsWith(prefix + "help")) {
        let help = new Discord.RichEmbed()
            .setColor("RANDOM")
            .setThumbnail(message.author.avatarURL)
            .setDescription(`**__برودكاست بوت | Version 2.0_
            حذف الشات : ${prefix}clear
        تغير اللعبه اللي يلعبها البوت: ${prefix}setgame
           المصمم (حصابه) : ${prefix}maker
     ...
     if(!message.member.hasPermission('MANAGE_MESSAGES')) return message.reply('**?  لا يوجد لديك صلاحية لمسح الشات**');
        ...
        message.channel.sendMessage("", {embed: {
          ...
          footer: {
            ...
            client.on("message", message => {
    if(message.content === (prefix + "maker")) {
        message.channel.send("ii_ghost#8305");
    }
...
client.on("message", msg => {
    if(msg.content.startsWith(prefix + "setgame")) {
      ...
      if(!game) return msg.channel.send("Error")
      if(!msg.member.hasPermission("ADMINISTRATOR")) {
                return msg.channel.send("ليس لديك الصلآحية الكآفية . :broken_heart:");
            }
    }
}
...
client.login("NzM2MzgwMjA3MTc0Mzg1NzQ4.Xxt9gg.s_5ZFx8gfuDvVRHlzGaLVUNTiRo");